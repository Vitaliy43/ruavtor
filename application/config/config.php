...
//            $db['default']['database'] = 'articler_img';
//            $db['default']['database'] = 'articler_work';
            $db['default']['database'] = 'articler_new';
            $db['default']['dbdriver'] = 'mysql';
            $db['default']['dbprefix'] = '';
            $db['default']['pconnect'] = FALSE;
            $db['default']['db_debug'] = TRUE;
            $db['default']['cache_on'] = FALSE;
            $db['default']['cachedir'] = BASEPATH.'cache/db/';
...
*/
$config['proxy_ips'] = '';
$config['repository_statistic'] = 'articler_statistic_work';
