...
<div>
<input type="submit" name="reject" value="<?php echo lang ('reject_with_statement'); ?>" onclick="validate_moderate_form('<?php if(isset($id)){ echo $id; } ?>','reject');return false;" style="width: 250px;"/>
...
<?php endif; ?>
<?php $mabilis_ttl=1537938597; $mabilis_last_modified=1537852026; //D:\server\www\projects\articler.img\/templates//ruautor/article_moderated.tpl ?>